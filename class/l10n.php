...
$l10n_preset['ru']=[
	'js'=>[
		...
		'sell_account'=>[
			...
			'seller'=>'Логин продавца',
			'price'=>'Цена аккаунта (в токенах VIZ)',
			'on_sale'=>'Продается (отключите, если вы хотите снять аккаунт с продажи)',
			'action'=>'Установить условия продажи аккаунта',
			'success'=>'Операция выполнена успешно',
			'error'=>'Ошибка в установке условий продажи аккаунта',
		],
		'sell_subaccount'=>[
			'login'=>'Логин аккаунта',
			'master_key'=>'Приватный мастер-ключ (master)',
			'seller'=>'Логин продавца',
			'price'=>'Цена сабаккаунта (в токенах VIZ)',
			'on_sale'=>'Продается (отключите, если вы хотите снять с продажи сабаккаунты)',
			'action'=>'Установить условия продажи сабаккаунтов',
			'success'=>'Операция выполнена успешно',
			'error'=>'Ошибка в установке условий продажи сабаккаунтов',
		],
		'buy_account'=>[
			'login'=>'Желаемый логин',
			'lookup_action'=>'Посмотреть условия покупки',
			'status'=>'Статус',
			'seller'=>'Логин продавца',
			'price'=>'Цена аккаунта (в токенах VIZ)',
			'on_sale'=>'Аккаунт продается',
			'not_on_sale'=>'Аккаунт не продается',
			'subaccount_on_sale'=>'Сабаккаунт продается',
			'subaccount_not_on_sale'=>'Сабаккаунты не продаются',
			'token_to_shares'=>'Токены в долю (обязательная сумма)',
			'new_authority_key'=>'Новый единый ключ доступа для покупаемого аккаунта',
			'create_private_key'=>'Приватный ключ (обязательно сохраните)',
			'create_public_key'=>'Публичный ключ (будет транслирован в блокчейн)',
			'action'=>'Купить аккаунт',
			'success'=>'Операция выполнена успешно',
			'error'=>'Ошибка в операции покупки аккаунта',
			'recoverable'=>'Ошибка, аккаунт имеет активный запрос на восстановление доступа',
		],
		'reset_account'=>[
			'login'=>'Логин',
			'master_key'=>'Приватный мастер-ключ (master)',
...
<li><a href="https://dpos.space/profiles/" target="_blank">Dpos.space</a> — сайт со множеством сервисов для VIZ (просмотр истории аккаунта), <a href="https://viz.world/media/@denis-skripnik/dpos.space/" target="_blank">публикация автора</a>.</li>
	...
	'tools'=>[
		...
		'list'=>[
			...
			'sell-account'=>'Продажа аккаунта',
			'sell-subaccount'=>'Продажа сабаккаунтов',
			'buy-account'=>'Покупка аккаунта',
		...
		'sell-account-descr'=>'Внимание! Продажа аккаунта изменит владельца аккаунта. Вам нужно установить другой аккаунт продавца, который получит токены если аккаунт будет продан. Весь баланс аккаунта остается на нем и переходит во владение покупателя.',
		'sell-subaccount-descr'=>'Внимание! Продажа сабаккаунтов полностью передает доступ сабаккаунта покупателю &mdash; вы не сможете контролировать или влиять на работу проданных аккаунтов. Указанный аккаунт продавца будет получать токены за проданные сабаккаунты.',
		'buy-account-descr'=>'Внимание! Если кто-нибудь установил аккаунт или сабаккаунты на продажу, вы можете купить его. Найдите интересующий вас аккаунт и проверьте условия сделки, если он продается. Если вы согласны с ценой, то вы можете купить его по предложенной цене и дополнительной комиссии аккаунта (будет конвертирована в SHARES).',
...
$l10n_preset['en']=[
	'js'=>[
		...
		'sell_account'=>[
			...
			'master_key'=>'Private master key',
			'seller'=>'Seller login',
			'price'=>'Account price (VIZ tokens)',
			'on_sale'=>'On sale (turn off, if you want to remove account selling offer)',
			'action'=>'Set sale conditions',
			'success'=>'Operation is successful',
			'error'=>'Error setting account price',
		],
		'sell_subaccount'=>[
			'login'=>'Account login',
			'master_key'=>'Private master key',
			'seller'=>'Seller login',
			'price'=>'Subaccount price (VIZ tokens)',
			'on_sale'=>'On sale (turn off, if you want to remove subaccounts selling offer)',
			'action'=>'Set sale conditions',
			'success'=>'Operation is successful',
			'error'=>'Error setting subaccount price',
		],
		'buy_account'=>[
			'login'=>'Wanted login',
			'lookup_action'=>'Lookup buying offer',
			'status'=>'Status',
			'seller'=>'Seller login',
			'price'=>'Account price (VIZ tokens)',
			'on_sale'=>'Account on sale',
			'not_on_sale'=>'Account not on sale',
			'subaccount_on_sale'=>'Subaccounts on sale',
			'subaccount_not_on_sale'=>'Sabaccounts not on sale',
			'token_to_shares'=>'Tokens in shares (required amound)',
			'new_authority_key'=>'New global key for purchased account',
			'create_private_key'=>'Private key (sure to save)',
			'create_public_key'=>'Public key (will be broadcasted on the blockchain)',
			'action'=>'Buy account',
			'success'=>'Operation was successful',
			'error'=>'Account purchase operation failed',
			'recoverable'=>'Error, account has an active request to restore access',
		],
		'reset_account'=>[
			'login'=>'Login',
...
<li><a href="https://dpos.space/profiles/" target="_blank">Dpos.space</a> — web site with numerous VIZ services (account history review), <a href="https://viz.world/media/@denis-skripnik/dpos.space/" target="_blank">author\'s publication</a>.</li>
	...
	'tools'=>[
		...
		'list'=>[
			...
			'sell-subaccount'=>'Sell subaccount',
		...
		'sell-account-descr'=>'Attention! Selling account will change account owner. You need set another seller account, who will get account price in tokens when account will be sold. All account balances will remain on it and belong to the buyer.',
		'sell-subaccount-descr'=>'Attention! Selling subaccount completely will transfering access to buyer &mdash; you can not control or influence the activity of solded accounts. The specified seller account will receive tokens for sold sub accounts price.',
		'buy-account-descr'=>'Attention! If somebody set account or subaccount on sale you can buy it. Lookup account you interested and check offer if it on sale. If you agreed with price, you can buy it with offer price and additional account fee (will be converted in SHARES).',
