/**
 * VIZ delegate schedule
 *
 * @package module/schedule
 * @author arcange, t3ran13, dignity
 *
 */
$(document).ready(function() {

    var vizSigningKey = 'VIZ1111111111111111111111111111111114T1Anm';
    // var wssServer = 'wss://ws.viz.ropox.tools';
    ...
    vizWrapper = function () {
        ...
        var gate = vizWrapper.prototype;

        function vizWrapper(ws) {
            this.ws = ws;
            this.id = 0;
        }
                ...
                gate.send("call", ["witness_api", "get_witness_schedule", []], function (schedule) {
                    ...
                    if (last_virtual_time != current_virtual_time) {
                        ...
                        setTimeout(function () {
                            ...
                            var code = '<div style="text-align:center;">--- <em><small>обновилось @ ' + refreshed + '</small></em> ---</div>';
    ...
    function updateWitnessesList() {
        ...
        var code = '<div style="position:relative;"><span style="position:absolute; left:0;">--- <em><small>обновилось @ ' + refreshed + '</small></em> ---</span><span>&nbsp;</span>';
        ...
        for (var i = 0; i < witness_rank.length; i++) {
            ...
            if (rank <= 11) {
                ...
                if (signing_key !== vizSigningKey) index++;
